...
## Project Description
This is the embedded component of the Essential Tremometer. C code was designed to run on a PIC16F1847 microcontroller. The microcontroller acts as a relay device simultaneously recording data from the ADXL345 accelerometer and relaying via bluetooth to a standalone PC. See full project [here](https://github.com/snimmagadda1/PD-and-ET-Tremor-Quantification) for additional information.
